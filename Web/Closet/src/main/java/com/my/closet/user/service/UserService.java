...
public interface UserService {
	...
	public String join(UserVO userInfo) throws DataAccessException; //회원가입
	...
	public String modifyProfileImage(MultipartHttpServletRequest multipartRequest) throws DataAccessException; //회원가입
	public String winmodifyProfileImage(MultipartHttpServletRequest multipartRequest) throws DataAccessException; //회원가입
