...
public interface CodiService {
	...
	public List<CodiVO> myAllCodi(HttpSession session, CodiVO codiFilter) throws DataAccessException; //내 코디 전부 조회
	
	public CodiVO infoCodi(String codiNo) throws DataAccessException; //특정 코디의 코디 정보 조회
	public List<CodiVO> searchCodi(HttpSession session, CodiVO codiFilter) throws DataAccessException; //특정 조건의 코디 정보 리스트 조회
