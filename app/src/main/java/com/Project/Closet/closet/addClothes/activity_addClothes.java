...
public class activity_addClothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_detailcategory.setVisibility(View.GONE);
        ...
        tv_edit_category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialogue_choose_category bottomSheetDialog = Dialogue_choose_category.getInstance();
                bottomSheetDialog.show(getSupportFragmentManager(),"bottomSheet");

            }
        });
        tv_edit_detailcategory = findViewById(R.id.tv_edit_detailcategory);
    ...
    public class UploadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            mapRequestBody.put("kind", RequestBody.create(MediaType.parse("text/plain"),kind));
            mapRequestBody.put("category", RequestBody.create(MediaType.parse("text/plain"),category));
            mapRequestBody.put("detailCategory", RequestBody.create(MediaType.parse("text/plain"), detailCategory));
            mapRequestBody.put("identifier", RequestBody.create(MediaType.parse("text/plain"), color+"_"+detailCategory));
            ...
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    sl_ok.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if(!detailCategory.isEmpty() && !color.isEmpty()){
    ...
    public void setCategories(String kind, String category, String detailCategory){
        this.kind=kind;
        this.category=category;
        this.detailCategory=detailCategory;

        if(!detailCategory.isEmpty()){
            tv_edit_category.setText(category);
            tv_edit_category.setTextColor(Color.parseColor("#000000"));
            warning.setVisibility(View.GONE);
            if(!category.equals(detailCategory)){
                ll_detailcategory.setVisibility(View.VISIBLE);
                tv_edit_detailcategory.setText(detailCategory);
                tv_edit_detailcategory.setTextColor(Color.parseColor("#000000"));
            }else{
                ll_detailcategory.setVisibility(View.GONE);
            }
        }
