    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_edit_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(activity_closet.this, listener, 2020, 6, 30);
                dialog.show();
            }
        });
        ...
        tv_edit_season.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(activity_closet.this);
